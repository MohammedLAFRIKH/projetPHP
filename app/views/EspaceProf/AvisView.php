...
class AvisView
{
        ...
        <div class="container mt-5">
            ...
            <form action="/apogee_ens/espaceadmin/submit_avis" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Choisir une ou plusieurs filières :</label>
                    <?php foreach ($groupeData as $row): ?>
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="groupe_<?php echo $row['id_grp']; ?>">
    ...
    // In AvisView.php
    public function showModifyAvisForm($avis,$error, $success,) {
        $isUserConnected = true;
